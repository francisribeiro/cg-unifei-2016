...
public class CirculoControl {
	...
	public void desenhaCantos(RetanguloModel retangulo, Color color) {
		...
		l1_x = retangulo.getLado1().getP1().x;
		l1_y = retangulo.getLado1().getP1().y + radius;
		l2_x = retangulo.getLado2().getP1().x - radius;
		l2_y = retangulo.getLado2().getP1().y;
		l3_x = retangulo.getLado3().getP1().x;
		l3_y = retangulo.getLado3().getP1().y - radius;
		l4_x = retangulo.getLado4().getP1().x + radius;
		l4_y = retangulo.getLado4().getP1().y;

		if (l1_x > l3_x && l1_y < l3_y) {
			l1_x = retangulo.getLado2().getP1().x + radius;
			l1_y = retangulo.getLado2().getP1().y;
			l2_x = retangulo.getLado1().getP1().x;
			l2_y = retangulo.getLado1().getP1().y + radius;
			l3_x = retangulo.getLado4().getP1().x - radius;
			l3_y = retangulo.getLado4().getP1().y;
			l4_x = retangulo.getLado3().getP1().x;
			l4_y = retangulo.getLado3().getP1().y - radius;
		} else if (l1_x > l3_x && l1_y > l3_y) {
			l1_x = retangulo.getLado3().getP1().x;
			l1_y = retangulo.getLado3().getP1().y + radius;
			l2_x = retangulo.getLado4().getP1().x - radius;
			l2_y = retangulo.getLado4().getP1().y;
			l3_x = retangulo.getLado1().getP1().x;
			l3_y = retangulo.getLado1().getP1().y - radius;
			l4_x = retangulo.getLado2().getP1().x + radius;
			l4_y = retangulo.getLado2().getP1().y;
		} else if (l1_x < l3_x && l1_y > l3_y) {
			l1_x = retangulo.getLado4().getP1().x + radius;
			l1_y = retangulo.getLado4().getP1().y;
			l2_x = retangulo.getLado3().getP1().x;
			l2_y = retangulo.getLado3().getP1().y + radius;
			l3_x = retangulo.getLado2().getP1().x - radius;
			l3_y = retangulo.getLado2().getP1().y;
			l4_x = retangulo.getLado1().getP1().x;
			l4_y = retangulo.getLado1().getP1().y - radius;
		}
	...
	public CirculoModel circuloInscrito(RetanguloModel retangulo) {
		...
		xa1 = Math.abs(retangulo.getLado1().getP1().x);
		xb1 = Math.abs(retangulo.getLado1().getP2().x);
		t1 = Math.sqrt(Math.pow((xb1 - xa1), 2));

		ya2 = Math.abs(retangulo.getLado2().getP2().y);
		yb2 = Math.abs(retangulo.getLado2().getP1().y);
		t2 = Math.sqrt(Math.pow((yb2 - ya2), 2));

		xc = Math.abs((retangulo.getLado1().getP2().x + retangulo.getLado1().getP1().x) / 2);
		yc = Math.abs((retangulo.getLado2().getP2().y + retangulo.getLado2().getP1().y) / 2);

		if (t1 <= t2) {
			xa = retangulo.getLado2().getP1().x;
			raio = (int) (Math.sqrt(Math.pow((xc - xa), 2)));
		} else {
			ya = retangulo.getLado1().getP1().y;
